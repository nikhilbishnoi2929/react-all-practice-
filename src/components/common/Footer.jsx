...
const Footer = ({backgroundColor = ' bg-[#1E1E1E]', text_color}) => {
            ...
            <div className=' container max-w-[1164px] mx-auto px-3 pt-[78px] pb-[61px]  '>
                <div className=' flex flex-row flex-wrap -mx-3 '>
                    <div className=' lg:w-6/12 w-full px-3 '>
                        <a href="" className={`${text_color} font-lato font-bold text-[38px] leading-[45px] text-[#FF5501]`}>Logo <span className=' text-white '>Here</span></a>
